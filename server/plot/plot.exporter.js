							...
							getFullMarkerSetParents({idMarkerSet: track.idMarkerSet}, dbConnection).then(marker_set => {
								...
								async.each(track.lines, function (line, nextLine) {
									...
									curveFunction.getFullCurveParents({idCurve: line.idCurve}, dbConnection).then(curveFullParents => {
										...
										newLine.textDisplayType = line.textDisplayType;
										newLine.textSize = line.textSize;
										newLine.textBackground = line.textBackground;
										newLine.textColor = line.textColor;
										newLine.textVerticalAlignment = line.textVerticalAlignment;
										newLine.textDisplayBoundary = line.textDisplayBoundary;
										newLine.arrayColumnCumulative = line.arrayColumnCumulative;
										newLine.arrayYLowerLimit = line.arrayYLowerLimit;
										newLine.arrayYUpperLimit = line.arrayYUpperLimit;
										newLine.arrayXStart = line.arrayXStart;
										newLine.arrayXStop = line.arrayXStop;
										newLine.arraySmooth = line.arraySmooth;
										newLine.arrayTraceColorPalette = line.arrayTraceColorPalette;
										newLine.arrayMatrixStartColor = line.arrayMatrixStartColor;
										newLine.arrayMatrixStopColor = line.arrayMatrixStopColor;
										newLine.arrayDisplayAs = line.arrayDisplayAs;
										newLine.arrayWindowSize = line.arrayWindowSize;
										newLine.arrayWindowUnit = line.arrayWindowUnit;
										newLine.arrayIntervalValue = line.arrayIntervalValue;
										newLine.arrayYScaleType = line.arrayYScaleType;
										newLine.arrayYUnit = line.arrayYUnit;
										newLine.arrayColumnFill = line.arrayColumnFill;
